            ...
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex flex-col leading-tight">
                        <span class="text-[10px] uppercase tracking-wider text-emerald-600 font-semibold">BoliviaTravel</span>
                        <span class="text-sm font-bold text-gray-800">Panel Cloud</span>
                    </a>
                </div>
